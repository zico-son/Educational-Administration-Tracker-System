...
router.register('students-affairs-statics', StudentsAffairsStaticsViewSet, basename='students-affairs-statics')
router.register('teachers', TeachersViewSet, basename='teachers')
router.register('teachers-statics', TeachersStaticsViewSet, basename='teachers-statics')
